...
// 팝업 상태  const [showCustomerModal, setShowCustomerModal] = useState(false);  const [showSeaportModal, setShowSeaportModal] = useState(false);  const [showHSCodeModal, setShowHSCodeModal] = useState(false);  const [currentCustomerField, setCurrentCustomerField] = useState<'shipper' | 'consignee' | 'notify'>('shipper');  const [currentPortField, setCurrentPortField] = useState<'pol' | 'pod'>('pol');  const [currentHSCodeIndex, setCurrentHSCodeIndex] = useState(0);
