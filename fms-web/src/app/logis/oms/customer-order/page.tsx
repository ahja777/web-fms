  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[var(--foreground)]">고객 오더 관리 (C/O)</h1>
          <p className="text-sm text-[var(--foreground)]/60 mt-1">Customer Order Management</p>
        </div>
        <button
          onClick={() => {
            resetForm();
      ...
      <div className="bg-[var(--surface-100)] rounded-xl p-4 border border-[var(--border)]">
        <div className="grid grid-cols-5 gap-4">
          ...
          <div>
            <label className="block text-xs text-[var(--foreground)]/60 mb-1">업무구분</label>
            <select
          ...
          <div className="flex items-end gap-2">
            ...
            <button
              onClick={() => setSearchFilters({ status: '', bizType: '', fromDate: '', toDate: '' })}
          ...
          <table className="w-full">
            <thead className="bg-[var(--surface-200)]">
              <tr>
                ...
                <SortableHeader<CustomerOrder> columnKey="status" label="상태" sortConfig={sortConfig} onSort={handleSort} />
                ...
                <SortableHeader<CustomerOrder> columnKey="quantity" label="수량" sortConfig={sortConfig} onSort={handleSort} />
                <SortableHeader<CustomerOrder> columnKey="weight" label="중량(KG)" sortConfig={sortConfig} onSort={handleSort} />
              ...
              {loading ? (
                ...
                sortData(orders).map((order) => (
                  <tr key={order.id} className="hover:bg-[var(--surface-200)]/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm font-medium text-[#E8A838]">{order.co_number}</td>
                    ...
                    <td className="px-4 py-3 text-sm">{order.commodity}</td>
                    <td className="px-4 py-3 text-sm text-right">{order.quantity?.toLocaleString()}</td>
                    <td className="px-4 py-3 text-sm text-right">{order.weight?.toLocaleString()}</td>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-xs text-[var(--foreground)]/60 mb-1">업무 구분</label>
                    <select
