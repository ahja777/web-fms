        ...
        <main ref={formRef} className="p-6">
          ...
          <div className="card p-6 mb-6">
            ...
            <div className="grid grid-cols-5 gap-4">
              ...
              <div><label className="block text-sm font-medium mb-1 text-[var(--muted)]">용적 (CBM)</label><input type="text" value={(data.volume_cbm || 0).toFixed(2)} disabled className="w-full px-3 py-2 bg-[var(--surface-100)] border border-[var(--border)] rounded-lg text-[var(--muted)]" /></div>
