              ...
              <div className="card">
                ...
                <div className="p-6">
                  <div className="grid grid-cols-6 gap-6">
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">운송모드</label>
                      <p className="text-[var(--foreground)] font-medium">{transportMode.icon} {transportMode.label}</p>
                    </div>
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">수출입</label>
                    ...
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">서비스타입</label>
                      <p className="text-[var(--foreground)] font-medium">{shipment.serviceType || '-'}</p>
                    </div>
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">인코텀즈</label>
                      <p className="text-[var(--foreground)] font-medium">{shipment.incoterms || '-'}</p>
                    </div>
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">운임조건</label>
                      <p className="text-[var(--foreground)] font-medium">{shipment.terms.freightTerm || '-'}</p>
                    </div>
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">결제조건</label>
                ...
                <div className="card">
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">국가</label>
                        <p className="text-[var(--foreground)] font-medium">{shipment.origin.countryName || shipment.origin.countryCode || '-'}</p>
                      </div>
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">항구/공항</label>
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      ...
                      {shipment.destination.finalDest && (
                        <div>
                          <label className="block text-sm text-[var(--muted)] mb-1">최종목적지</label>
              ...
              <div className="card">
                ...
                <div className="p-6">
                  <div className="grid grid-cols-4 gap-6">
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">고객사</label>
                    ...
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">운송사 (Carrier)</label>
              ...
              <div className="card">
                ...
                <div className="p-6">
                  <div className="grid grid-cols-3 gap-6">
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">고객 참조번호</label>
                      <p className="text-[var(--foreground)] font-medium">{shipment.references.customerRef || '-'}</p>
                    </div>
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">PO 번호</label>
                      <p className="text-[var(--foreground)] font-medium">{shipment.references.poNo || '-'}</p>
                    </div>
                    <div>
                      <label className="block text-sm text-[var(--muted)] mb-1">SO 번호</label>
              ...
              {shippingRequest && (
                <div className="card">
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-4 gap-6">
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">S/R 번호</label>
                      ...
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">품명</label>
              ...
              {shippingNotice && (
                <div className="card">
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-4 gap-6">
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">S/N 번호</label>
                        <p className="text-[var(--foreground)] font-semibold text-blue-600 cursor-pointer hover:underline">
                          {shippingNotice.SN_NO || '-'}
                        </p>
                      </div>
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">선박/항공편</label>
                        <p className="text-[var(--foreground)]">{shippingNotice.VESSEL_FLIGHT || '-'}</p>
                      </div>
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">항차번호</label>
                        <p className="text-[var(--foreground)]">{shippingNotice.VOYAGE_NO || '-'}</p>
                      </div>
                      <div>
                        <label className="block text-sm text-[var(--muted)] mb-1">발송상태</label>
